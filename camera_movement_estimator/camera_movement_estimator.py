...
class CameraMovementEstimator:
    ...
    def draw_camera_movement(self, frames, camera_movement_per_frame):
        ...
        for frame_num, frame in enumerate(frames):
            ...
            frame = cv2.putText(frame, f"Camera Movement X: {x_movement: .2f}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 0, 0), 3)
            frame = cv2.putText(frame, f"Camera Movement Y: {y_movement: .2f}", (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 0, 0), 3)  
